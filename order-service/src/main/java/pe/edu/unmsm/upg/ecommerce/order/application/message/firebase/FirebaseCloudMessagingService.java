package pe.edu.unmsm.upg.ecommerce.order.application.message.firebase;
...
public class FirebaseCloudMessagingService {
	 ...
	 private Logger logger = LoggerFactory.getLogger(FirebaseCloudMessagingService.class);
